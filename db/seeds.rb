...
User.create(name: "Mike Wilder", email: "mike@wild.er", password: "hello")
...
Milestone.create(lead_time: "120", name: "present proofs", description: "give customer time to review and suggest changes", project_id: 2)